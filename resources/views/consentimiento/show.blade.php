...
@section('content')
    ...
    <ol>
        <li>I express my Free will to receive the administration of INTRAVENOUS and/or INTRAMUSCULAR medications and
            solutions.</li><br>
        <li>The nurse <strong>{{ $consentimiento->nurse_name }}</strong> with professional ID
            <strong>{{ $consentimiento->nurse_id }}</strong>
        ...
        <p>The nurse is complying with all the hygiene and protection measures to avoid the spreading of the COVID-19 virus.
            ...
            is required (either from a doctor or from a medical institution), it is the responsibility and decision of the
            patient/client to follow recommendations, releasing
            ...
            once the benefits have been explained to me. I understand the possible complications, reactions, and results,
            assuming the consequences of this decision.</p>
    </ol>
    ...
    @if ($consentimiento->digital_signature)
        <img src="{{ $consentimiento->digital_signature }}" width="300">
    @else
